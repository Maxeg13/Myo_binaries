/****************************************************************************
** Meta object code from reading C++ file 'serialqobj.h'
**
...
#include "../../Kohonen-map-MyoArmband/serialqobj.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'serialqobj.h' doesn't include <QObject>."
...
void serial_obj::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        serial_obj *_t = static_cast<serial_obj *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject serial_obj::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_serial_obj.data,
      qt_meta_data_serial_obj,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *serial_obj::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_serial_obj.stringdata0))
        return static_cast<void*>(const_cast< serial_obj*>(this));
